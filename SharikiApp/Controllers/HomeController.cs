...
namespace SharikiApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            ViewBag.Title = "Заказать печать на шарах, цена | Мастерская шариков Дядя Женя, Екатеринбург";
            ViewBag.Type = "article";
            ViewBag.Url = SiteName + "Pechat_na_sharah";
            ViewBag.Keywords = "Екатеринбург, печать на шарах, шарики с логотипом, печать на воздушных шарах";
            ViewBag.Description = "Хотите увеличить свои клиентские потоки, привлечь внимание к новой продукции или же просто оригинально поздравить близких с праздником? Наша мастерская предлагает вам печать на воздушных шарах в Екатеринбурге. У нас всегда доступные расценки, оперативное изготовление заказа, а также индивидуальный подход к каждому клиенту.";
            return View();
        }
        ...
        public ActionResult Balloons(BalloonTypeM? type)
        {
            ...
            ViewBag.Path = VirtualPathRootName;
            ViewBag.Title = "Заказать воздушные шары с доставкой – Мастерская шариков Дядя Женя, Екатеринбург";
            ViewBag.Keywords = "Воздушные шары с доставкой, заказать шары, шары на заказ, цена, заказать, Екатеринбург";
            ViewBag.Description =
                "Мы предлагаем широкий выбор воздушных шаров с доставкой по любому адресу в Екатеринбурге, а также лучшую стоимость оригинальных товаров на нашем сайте. У нас вы сможете найти шары, которые украсят любой праздник.";
            ...
            switch (balloonType)
            {
                case BalloonTypeM.Latex:
                    ViewBag.Title = "Заказать латексные шарики, цена | Мастерская шариков Дядя Женя, Екатеринбург";
                    ViewBag.Keywords = "Цена, купить, Екатеринбург, выбор воздушных шаров";
                    ViewBag.Description = "Воздушные шары помогают в создании особой атмосферы праздника, поэтому наша мастерская предлагает своим клиентам большой ассортимент шаров по приемлемым ценам в Екатеринбурге. У нас вы всегда сможете заказать качественные и оригинальные шары разных форм, цветов и размеров на выбор.";
                    break;
        ...
        public ActionResult Decorate(BalloonTypeM? type, string searchText)
        {
            ...
            switch (balloonType)
            {
                case BalloonTypeM.DecoreBirthDay:
                    ViewBag.Title = "Заказать оформление зала – Мастерская шариков Дядя Женя, Екатеринбург";
                    ViewBag.Keywords = "Оформление зала, комнаты, воздушными шарами на день рождения, детского дня рождения, день рождения ребенка, цена, заказать, Екатеринбург";
                    ViewBag.Description = "Наша компания предлагает заказать оформление зала для празднования детского дня рождения на странице нашей компании. Мы гарантируем качество и оперативность выполнения заявки.";
                    break;
